...
class EvenementController extends AbstractController
{
     ...
     * @param EvenementRepository $repo
     * @return Response
     * @Route("/adminAfficherE",name="admin_afficherE")
     */

    public function Affiche_Admin(EvenementRepository $repo )
    {
        $evenement=$repo->findAll();
        return $this->render('evenement/adminafficherE.html.twig',['evenement'=>$evenement]);
    }
    /**
     ...
     * @param EvenementRepository $repo
     * @return \Symfony\Component\HttpFoundation\RedirectResponse
     * @Route("/delete_evenement_admin/{id}", name="delete_evenementadmin")
     */
     ...
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|Response
     * @Route ("/evenement/ModifierEadmin/{id}", name="modifierEadmin")
     */
    public function ModifierAdmin(EvenementRepository  $repository, $id,Request $request){
        ...
        return $this->render('evenement/adminModifierEvenement.html.twig',[
            'form'=>$form->createView()
        ]);
    }
