...
class ParticipationController extends AbstractController
{
     ...
     * @Route("/participation/AjouterP", name="ajoutP")
     */
     ...
     * @param ParticipationEveRepository $repo
     * @return Response
     * @Route("/adminAfficherP",name="admin_afficherP")
     */

    public function Affiche_Admin(ParticipationEveRepository $repo )
    {
        $participation=$repo->findAll();
        return $this->render('evenement/adminafficheP.html.twig',['participation'=>$participation]);
    }
     ...
     * @param ParticipationEveRepository $repo
     * @return \Symfony\Component\HttpFoundation\RedirectResponse
     * @Route("/delete_participation_admin/{id}", name="delete_participationadmin")
     */
     ...
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|Response
     * @Route ("/participation/ModifierPadmin/{id}", name="modifierPadmin")
     */
    public function ModifierAdmin(ParticipationEveRepository $repository, $id,Request $request){
        ...
        return $this->render('participation/adminModifierParticipation.html.twig',[
            'form'=>$form->createView()
        ]);
    }
